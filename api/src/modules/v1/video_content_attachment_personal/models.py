...
class VideoContentAttachmentPersonal(models.Model):
    ...
    video_content_attachment = models.ForeignKey('VideoContentAttachment', models.DO_NOTHING, blank=True, null=True)
    is_finished = models.BooleanField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'video_content_attachment_personal'